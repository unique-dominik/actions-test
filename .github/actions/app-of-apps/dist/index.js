...
function appOfApps({ inDir, outDir, glob, supportedVersions, ignore }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, ymlsGlob_1 = __asyncValues(ymlsGlob), ymlsGlob_1_1; ymlsGlob_1_1 = yield ymlsGlob_1.next(), _a = ymlsGlob_1_1.done, !_a;) {
                _c = ymlsGlob_1_1.value;
                _d = false;
                try {
                    const candidate = _c;
                    try {
            ...
            try {
                if (!_d && !_a && (_b = ymlsGlob_1.return)) yield _b.call(ymlsGlob_1);
            }
        ...
        for (const spec of applicationSpecs) {
            ...
            yield (0, promises_1.mkdir)((0, path_1.resolve)(process.cwd(), outDir, newDirName), { recursive: true });
...
function isArgoSpec(supportedVersions, application) {
    ...
    return (((_a = application.metadata) === null || _a === void 0 ? void 0 : _a.name) &&
        ...
        ((_g = (_f = application.metadata) === null || _f === void 0 ? void 0 : _f.labels) === null || _g === void 0 ? void 0 : _g.name) &&
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const app_of_apps_1 = __nccwpck_require__(983);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
